...
int do_tests_on_empty_root(struct st_root *root)
{
...
int do_add_and_remove_tests(struct st_root *root)
{
	unsigned int tests = 0;
...
int do_uniqueness_tests(struct st_root *root)
{
	unsigned int tests = 0;
	int i, j;
...
int do_shortest_match_tests(struct st_root *root)
{
	unsigned int tests = 0;
...
int do_case_insensitive_tests(struct st_root *root)
{
	unsigned int tests = 0;
...
int do_destroy_tests(struct st_root *root)
{
	unsigned int tests = 0;
...
int main(int argc, char *argv[])
{
	...
	tests += do_tests_on_empty_root(&root);
	tests += do_add_and_remove_tests(&root);
	tests += do_uniqueness_tests(&root);
	tests += do_shortest_match_tests(&root);
	tests += do_case_insensitive_tests(&root);
	tests += do_destroy_tests(&root);
